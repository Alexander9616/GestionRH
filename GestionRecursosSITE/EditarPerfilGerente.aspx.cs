...
public partial class EditarPerfilGerente : System.Web.UI.Page
{
    private static string id;
    private static string direccion, telefono;
    protected void Page_Load(object sender, EventArgs e)
    {
        id = "Gerente1"; //esto debe cambiar por el valor que envía la sesión por medio de asp
    ...
    protected void btnActualizar_Click1(object sender, EventArgs e)
    {
        if (Actualizar())
        {
            ...
            Response.Write("<script>location.href='EditarPerfilGerente.aspx';</script>");
        }
        else
        {
